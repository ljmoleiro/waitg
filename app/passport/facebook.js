...
const passport = require('passport'),
    ...
    userProfile = require('../backend/models').UserProfile,
    facebookUser = require('../backend/models').FacebookProfile,
    userController = require('../controllers').userController;

const facebookConfig = function(app){
    passport.use(new facebookStrategy({
            clientID: (process.env.WAITG_FACEBOOK_APP_ID || ""),
            clientSecret: (process.env.WAITG_FACEBOOK_APP_SECRET || ""),
